...
device_names="$bigip_03_name"                     ## This list includes only the newly added devices
...
device_names="$bigip_01_name $bigip_02_name $bigip_03_name"                  ## This list includes the initial BIGIP-HA names (BIGIP01 and BIGIP02) along with the newly added devices
